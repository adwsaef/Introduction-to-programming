...
struct interesant {
  ...
  int num;
  interesant *first, *second;
  // first_to_me - pointer to *first's pointer to me. if first==nullptr, pointer to office's pointer to me
  // second_to_me - pointer to *second's pointer to me. if second==nullptr, pointer to office's pointer to me
  interesant **first_to_me, **second_to_me;
  void reset() {
    first = nullptr, second = nullptr, first_to_me = nullptr, second_to_me = nullptr;
  }
  void upd(interesant* a, interesant* b, interesant** c, interesant** d) {
    first = a, second = b, first_to_me = c, second_to_me = d;
  }
  // A kończy tu
};
